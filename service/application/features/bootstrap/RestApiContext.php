 ...
 * @package AppBundle\UserService\Context
 */
...
//        print_r($data);
    ...
    public function iSendARequestWithValues($method, $url, TableNode $post)
    {
        ...
        $this->request = $this->getClient()->request($method, $url, $option);
    }
    ...
    // TODO :  Update the HTTP POST Request in this method to match the requirements of Guzzle 6.x
